...
export default function TermsPrivacy() {
  return (
    <>
      <Head>
        <title>Política de Privacidade | Rafaelvieiras</title>
      </Head>
      <main className="relative scroll-smooth flex flex-col gap-8">
        ...
        <div className="container mx-auto prose">
          ...
          <p>
            A sua privacidade é importante para nós. É política do Rafaelvieiras
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site{" "}
            <a href="https://www.rafaelvieiras.com">Rafaelvieiras</a>, e outros
          ...
          <p>
            ...
            dentro de meios comercialmente aceitávei para evitar perdas e
          ...
          <p>
            ...
            informação que o Rafaelvieiras oferece no site e com caráter
          ...
          <p>Esta política é efetiva a partir de&nbsp;30 March 2023 16:18</p>
        </div>
      </main>
      <CookiesModal />
    </>
